...
int main()
{
    system("cls");
                        ...
                        cout << "\t\t===================================================" << endl;
                        cout << "\t\t==    W E L C O M E   T O   B U L T A N  ==" << endl;
                        cout << "\t\t===================================================" << endl << endl;
            ...
            do{
             ...
             cout<<endl<<"How can i help you sir...."<<endl<<endl;
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant created by my friend  !!!"<<endl;
                    string phrase = "I am a virtual assistant created by my friend ";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
